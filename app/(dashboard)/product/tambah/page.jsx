        ...
        <div className="max-w-2xl mx-auto">
            ...
            <form action={handleSubmit} className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 items-center">
                    <label htmlFor="name" className="text-sm fot-semibold text-gray-700 md:text-right md:pr-4 order-1 md:order-1">
                        Nama Produk *
                    </label>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 items-center">
                    <label htmlFor="price" className="text-sm font-semibold text-gray-700 md:text-right md:pr-4 order-1 md:order-1">
                        Harga (Rp) *
                    </label>
                    <div className="md:col-span-2 order-2 md:order-2">
                        <input 
                ...
                <div className="md:col-start-2 md:col-span-2 flex gap-4 pt-4">
                    <button type="submit" className="flex-1 bg-blue-600 text-white py-3 px-6 rounded-lg font-semibold hover:bg-blue-700 transition-colrs focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
                        Simpan Produk
                    </button>
                    <Link href="/product" className="flex-1 bg-gray-500 text-white py-3 px-6 rounded-lg font-semibold text-center hover:bg-gray-600 transition-colors">
                        Batal
                    </Link>
                </div>
            </form>
